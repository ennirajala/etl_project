...
PATH_ENNI = "/home/ennirajala/enni-sini/"
PATH_SINI = "/home/sinivuor/enni-sini/etl_project/"
...
def _cleanse_fmi_data(fmi_df):
    ...
    fmi_df.to_csv(PATH_ENNI + "fmi_cleaned.csv", index=False)
...
def _cleanse_smhi_data(smhi_df):
    ...
    # Save clensed data as csv file
    smhi_df.to_csv(PATH_ENNI + "smhi_cleaned.csv", index=False)
